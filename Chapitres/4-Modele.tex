...
On a aussi définit des entreprises, avec un secteur, un nombre de place vacantes, etc, même si on n'utilise pas du tout ces entreprises pour l'instant.  
...
L'idée d'avoir un registre permet est une double bonne idée. 
...
On a évidemment des lien du registre vers les individus et des individus vers le registre. Ce lien est un peu spécial puisqu'il est one2one finalement, doublement injectif. 
