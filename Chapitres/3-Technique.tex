...
En fait, on peut même dire qu'on utilise la somme des probabilité quand tout ce qu'on a c'est une probabilité et on utilise l'autre méthode (avec logit_score) lorsque l'on a des données extérieures. 
\newpage
