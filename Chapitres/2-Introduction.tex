...
La structure du modèle doit permettre à ce qu'un travail sur les choix de départ en retraite profite aux études qui étudient la consommation des personnes âgées par exemple. 
