...
\subsubsection{Les revenus peuvent varier d'une année à l'autre.}
Plusieurs éléments peuvent expliquer des variations de revenus d'une année à l'autre.
...
\subsubsection{Les revenus varient en fonction de la période de la vie.} 
...
\subsubsection{L'ambigüité patrimoine vs revenus}
...
\subsection{La redistribution within (intrapersonnelle)}
...
\subsection{Les transferts assurantiels}
