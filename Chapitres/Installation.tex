...
Add "\emph{C\NoAutoSpaceBeforeFDP:\textbackslash Python27;C\NoAutoSpaceBeforeFDP:\textbackslash Python27\textbackslash Scripts;C\NoAutoSpaceBeforeFDP:\textbackslash Python27\textbackslash Lib\textbackslash site-packages}"
\footnote{C:\textbackslash Python27 can be replace by your python directory if you haven't chosen the default installation} 
in the existing Path variable inside the environment variables of your system.
\footnote{\label{path} For Windows users, find "computeur", the root of your system, select Properties after a right-click on computer.
Then click Advanced system settings > Advanced tab > Environment Variables. Modify the existing variable \emph{Path} separating folders by semicolons with no blank.
Please note that programs usually load the environment variables when they open so you may have to restart them to see your modification impact}. \\


%Add "C\NoAutoSpaceBeforeFDP:\textbackslash Python27;C\NoAutoSpaceBeforeFDP:\textbackslash Python27\textbackslash Scripts;C\NoAutoSpaceBeforeFDP:\textbackslash Python27\textbackslash Lib\textbackslash site-packages"
%\footnote{C:\textbackslash Python27 can be replace by your python directory if you haven't chosen the default installation} 
%is in the environment variable path of your system  
%\footnote{ \label{path} For Windows users, find "computeur", the root of your system, select Properties after a right-click on computer.
%Then click Advanced system settings > Advanced tab > Environment Variables. Modify Path separating folders by semicolons with no blank.}.//
...
Ceci peut se faire en appuyant sur Auto Config\footnote{Si cela ne marche pas, il est possible que cela soit dû à une mauvaise redéfinition de la variable d'environnement Path au 7.1.1}.  \\
