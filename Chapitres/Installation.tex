...
Il y a dans le dossier Til\textbackslash pgm un fichier CONFIG\_ to\_ rename.py . 
...
Encore plus loin, si vous voulez faire tourner les données depuis leur création à partir de l'enquête patrimoine, il faut faire tourné run\_ all.R dans le fichier Til\textbackslash data\textbackslash Patrimoine (en ayant précisé le chemin de l'enquête patrimoine 2010).
